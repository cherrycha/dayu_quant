...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['alpha171', 'alpha145', 'alpha140', 'DilutedEPS', 'Mfi','MTM','CMO','SUIO']
...
import alpha171,alpha145,alpha140,DilutedEPS,Mfi,MTM,CMO

for f in ['alpha171', 'alpha145', 'alpha140', 'DilutedEPS', 'Mfi','MTM','CMO']:
